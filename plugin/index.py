...
# Class functions
classRegex = re.compile(r"^(?!default|function|return|var|case|delete|if|switch|void|catch|do|in|this\.|while|const|else|insnceof|throw|with|continue|finally|let|try|debugger|for|new|typeof|function|export)^([a-zA-Z]|(_){1}[a-zA-Z])( )?(.)*[(].*[)].*[{]")
classMatches = []
